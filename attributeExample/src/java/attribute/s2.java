...
public class s2 extends HttpServlet {
   ...
   protected void processRequest(HttpServletRequest request, HttpServletResponse response)
      ...
      try {
         ...
         out.println("<h1>servlet2</h2>");
         //get and converting string into integer
         ...
         //gett attribute from request object
        String su=(String) request.getAttribute("sum");
        int ss=Integer.parseInt(su);
         
        out.println("<h1>");
         
        out.println("sum:"+ss);
        out.println("<br>product:"+p);
